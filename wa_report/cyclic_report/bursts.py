...
"bulky images" into the chat. ``render_combined.build_payload`` collects the
image-send times; this module groups them into *bursts* (a run of photos each
within a few minutes of the last) — one burst becomes one marker on the graph.
"""
